export const API_ROUTES = {
  ...
  GETCOLLEGES: universityId => `public/universities/${universityId}/colleges`,
  ...
  LOGOUT_DEVICE: 'student/logout-device',
  GETALL_EVENT_LIST: 'student/events',
  CALENDER_EVENT_API: 'student/events/calendar',
  RSVP_STUTAS: 'student/events/rsvp',
  DEATILS_BY_ID: 'student/events',
  CONTACT_FROM: 'student/contact-forms/submit',
  GET_LEADERBOARD: (page, limit, period) =>
    `student/leaderboard?period=${period}&page=${page}&limit=${limit}`,
