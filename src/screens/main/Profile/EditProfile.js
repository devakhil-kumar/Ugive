            ...
            <View style={styles.formContainer}>
              {activeTab === 'editProfile' && (
                <View>
                  ...
                  <AppText style={styles.cardLabelTextStyle}>Email</AppText>
                  <CustomTextField
                    value={email}
                  ...
                  <AppText style={styles.cardLabelTextStyle}>
                    University
                  </AppText>
                  <CustomTextField
                    value={university}
                  ...
                  <AppText
                    style={[styles.cardLabelTextStyle, { marginTop: 0 }]}
                  >
                    USI
                  </AppText>
                  <CustomTextField
                  ...
                  <View style={[styles.inputGroup, { marginBottom: 10 }]}>
                    ...
                    <View style={styles.passwordContainer}>
                      ...
                      >
                        <Icon
                          name={
                            newShowPassword ? 'eye-off-outline' : 'eye-outline'
                          }
                          size={20}
                          color="#C4C4C4"
                        />
                  ...
                  <View style={[styles.inputGroup, { marginBottom: 0 }]}>
                    ...
                    <View style={styles.passwordContainer}>
                      ...
                      >
                        <Icon
                          name={
                            conshowPassword ? 'eye-off-outline' : 'eye-outline'
                          }
                          size={20}
                          color="#C4C4C4"
                        />
              ...
              <View style={styles.buttonRow}>
                ...
                >
                  <AppText style={styles.txtBtn}>Cancel</AppText>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                  <AppText style={styles.txtBtn}>Save</AppText>
                </TouchableOpacity>
              </View>
            </View>
          </View>
