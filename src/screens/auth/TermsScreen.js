...
const TERMS_DATA = [
  ...
  },
  {
    ...
    title: '11. Contact',
    content:
      'For questions about these Terms or the operation of the App, please contact:\n\nUGive Support\nhello@ugive.com.au',
  },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {/* <AppText style={styles.headerSubtitle}>UGive</AppText> */}
      </View>
      ...
      >
        <AppText style={styles.introText}>
          Welcome to UGive. By downloading, accessing or using the UGive app
          ...
          App. "UGive" for the purpose of these terms and conditions refers to
          both the app and the host entity, Highlands Church.
        </AppText>
      ...
      {/* <View style={styles.footer}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={styles.agreeButton} onPress={handleAgree}>
            <AppText style={styles.agreeButtonText}>I Agree</AppText>
          </TouchableOpacity>
        </View>
      </View> */}
    </SafeAreaView>
